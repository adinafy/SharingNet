...
1. **הרשמה**: צרו חשבון → **המערכת מתנתקת אוטומטית** → הודעה פשוטה מוצגת
2. **אימות מייל**: בדקו את המייל → לחצו על קישור האימות
3. **התחברות**: פתחו את האתר מחדש → התחברו עם הפרטים שלכם
...
7. **הזרימה הנכונה**: הרשמה → התנתקות אוטומטית → הודעה פשוטה → בדיקת מייל → לחיצה על קישור → פתיחת האתר מחדש → התחברות
