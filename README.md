...
3. **הגדירו Site URL** לכתובת האתר שלכם
4. **הגדירו Redirect URLs** בהתאם
...
1. **הרשמה**: צרו חשבון → בדקו את המייל → לחצו על קישור האימות
2. **התחברות**: התחברו עם הפרטים שלכם לאחר אימות המייל
...
3. **השתמשו ב-HTTPS** למערכות production
